...
import { Briefcase, Store, Users, Package, DollarSign, TrendingUp, TrendingDown } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";

const stats = [
//   { icon: Briefcase, label: "Companies", value: 10, color: "text-blue-600 bg-blue-100" },
  { icon: Store, label: "Stores", value: 50, color: "text-blue-600 bg-blue-100" },
  { icon: Users, label: "Workers", value: 120, color: "text-yellow-600 bg-yellow-100" },
  { icon: Package, label: "Products", value: 350, color: "text-purple-600 bg-purple-100" },
  { 
    icon: DollarSign, 
    label: "Revenue", 
    value: "$50K", 
            ...
            <CardContent>
              ...
              {stat.trend && (
                <div className="text-sm flex items-center space-x-1">
                  <stat.trend.icon size={16} className={stat.trend.trendColor} />
